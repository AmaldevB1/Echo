...
class SettingsFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val prefs = myActivity?.getSharedPreferences(statified.MYPREFSNAME, Context.MODE_PRIVATE)
        ...
        shakeSwitch?.setOnCheckedChangeListener({ buttonView: CompoundButton?, isChecked: Boolean ->
            if (isChecked as Boolean) {
                val editor = myActivity?.getSharedPreferences(statified.MYPREFSNAME, Context.MODE_PRIVATE)?.edit()
